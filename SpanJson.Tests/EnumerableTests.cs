...
namespace SpanJson.Tests
{
    ...
    {
        public class CustomEnumerable<T>(IEnumerable<T> values) : IEnumerable<T>, IEquatable<CustomEnumerable<T>>
        {
        ...
        {
            var collection = new Queue<string>(["Hello", "World"]);
            var serialized = JsonSerializer.Generic.Utf16.Serialize(collection);
            Assert.NotNull(serialized);
        ...
        {
            var collection = new ConcurrentQueue<string>(["Hello", "World"]);
            var serialized = JsonSerializer.Generic.Utf16.Serialize(collection);
            Assert.NotNull(serialized);
        ...
        {
            var collection = new ConcurrentBag<string>(["Hello", "World"]);
            var serialized = JsonSerializer.Generic.Utf16.Serialize(collection);
            Assert.NotNull(serialized);
        ...
        {
            var collection = new HashSet<string>(["Hello", "World"], StringComparer.Ordinal);
            var serialized = JsonSerializer.Generic.Utf16.Serialize(collection);
            Assert.NotNull(serialized);
        ...
        {
            var collection = new Stack<string>(["Hello", "World"]);
            var serialized = JsonSerializer.Generic.Utf16.Serialize(collection);
            Assert.NotNull(serialized);
        ...
        {
            var collection = new ConcurrentStack<string>(["Hello", "World", "Universe"]);
            var serialized = JsonSerializer.Generic.Utf16.Serialize(collection);
            Assert.NotNull(serialized);
            Assert.Throws<NotSupportedException>(() => JsonSerializer.Generic.Utf16.Deserialize<ConcurrentStack<string>>(serialized));
        }
        ...
        {
            var collection = new LinkedList<string>(["Hello", "World"]);
            var serialized = JsonSerializer.Generic.Utf16.Serialize(collection);
            Assert.NotNull(serialized);
        ...
        public void SerializeDeserializeEnumerableHelperUtf16()
        {
            var eh = new EnumerableHelper
            {
                ...
                Dictionary = new Dictionary<string, string>(StringComparer.Ordinal) { {"a", "b"}, {"b", "c"}}
            };
